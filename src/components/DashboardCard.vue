<script setup>
    ...
    const { title, value, icon, color } = defineProps({
    ...
    switch (color) {
        case 'green': return 'bg-gradient-to-tr from-green-500 to-green-600'
        case 'blue': return 'bg-gradient-to-tr from-blue-500 to-blue-600'
