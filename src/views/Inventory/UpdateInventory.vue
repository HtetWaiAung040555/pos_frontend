            ...
            <template #cardElements>
                ...
                <div class="flex gap-x-4 mt-6">
                    ...
                    <div class="flex flex-col gap-y-1">
                        <BaseLabel label="Product" :isRequire="true" />
                        <Select v-model="selectedProduct" :options="useProduct.productList" showClear filter
                            optionLabel="name" placeholder="Select a product" class="w-[300px] h-[35px] items-center" />
                ...
                <div class="flex gap-x-4 mt-4">
                    <!-- Qty input -->
                    <BaseInput size="sm" v-model="formData.qty" label="Qty" placeholder="Stock Qty" width="300px"
                        height="h-[35px]" type="number" :isRequire="true" :error="errorMsg.qty" />
                    <!-- Expired date input -->
                    <BaseInput size="sm" v-model="formData.expired_date" label="Expired Date" width="300px"
                        height="h-[35px]" type="date" />
                </div>
                <div class="flex justify-end mt-4">
                    <!-- Save Button -->
                    <BaseButton label="Update" :isLoading="useInventory.loading"
